"""CLI command untuk impor data penjualan."""
...
from src.utils.messages import BANNER_SALES
from src.utils.progress import run_progress

app = typer.Typer(name="sales", help="Impor data penjualan/invoice")
console = Console()
...
def import_data(
    ...
    """Impor data penjualan/invoice ke tabel Supabase yang dinormalisasi."""
